...
public enum IntelligenceEnum {
    ABSENT_IQ(0, 0, 0, 0, 0x1337, 0, false),
    SPIDER(5, 8.5, 0.75, 10, 45, 3, false),
    BLOB(7, 12, 1, 20, 30, 3, false);
    ...
    IntelligenceEnum(double aggressionRange, double chasingRange, double attackRange, int attackDamage, int attackCooldownTicks, double speed, boolean canAlarm) {
